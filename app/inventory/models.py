...
@python_2_unicode_compatible
class WirelessOutlet(models.Model): 
    name = models.CharField(
                        max_length=24, 
                        unique=True, 
                        blank=False, 
                        null=False,
                        default='Outlet 1',
                        help_text='The name you will refer to this outlet as. Must be unique. 24 characters')
...
class WirelessTx(models.Model):
    gpio = models.IntegerField(
                        ...
                        unique=True,
                        validators=[MaxValueValidator(31), MinValueValidator(0)],
                        help_text='GPIO pin number the wireless transmitter is attached to.')

    def __str__(self):
        return "Wireless TX gpio pin %d" % self.gpio
